...
export type TeamMember = {
  ...
  name?: string;
  slug?: Slug;
  position?: 'founder' | 'developer' | 'creative' | 'marketing';
  quote?: string;
...
// Variable: TEAM_MEMEBER_QUERY
// Query: *[_type == 'teamMember' && defined(slug.current)]{  name,  slug,  position,  quote,  links,  mainImage{    asset->{      url    },    alt  },  _createdAt } | order(_createdAt)
export type TEAM_MEMEBER_QUERYResult = Array<{
  name: string | null;
  slug: Slug | null;
  position: 'creative' | 'developer' | 'founder' | 'marketing' | null;
  quote: string | null;
